...
<div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8"
    ...
    {{-- ============================================= --}}
    <div x-show="detailModalOpen" x-transition class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto" @keydown.escape.window="closeDetailModal()" x-cloak>
        {{-- Wrapper Modal --}}
        <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl flex flex-col relative" style="max-height: 90vh;" @click.away="closeDetailModal()">
            ...
            <div class="modal-content-area p-6 space-y-5 text-sm flex-grow overflow-y-auto"> {{-- PERBAIKAN: Menambahkan 'flex-grow' --}}
